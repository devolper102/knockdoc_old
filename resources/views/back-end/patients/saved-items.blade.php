                                            ...
                                            @foreach ($saved_doctors as $key => $user_id)
                                                @php
                                                    ...
                                                    $specialities = DB::table('user_service')->select('speciality')
                                                        ->where('user_id', $user_obj->id)->groupBy('speciality')->get()->pluck('speciality')->random(0)->toArray();
                                                @endphp
                                                <div class="dc-docpostholder la-docpostholder">
                                                    <div class="dc-docpostcontent">
                                                        <div class="dc-searchvtwo">
                                                            ...
                                                            <div class="dc-title" style="min-height: 170px;">
                                                                ...
                                                                <div class="dc-title" style="min-height: 170px;">
                                                                    @if (!empty($specialities))
                                                                        @foreach ($specialities as $key => $user_speciality)
                                                                            @php $speciality = Helper::getSpecialityByID($user_speciality); @endphp
                                                                            @if (!empty($speciality))
                                                                               <a href="{{ url('/speciality'.clean($speciality->slug)) }}" class="dc-docstatus">{{ html_entity_decode(clean($speciality->title)) }}</a>
                                                                            @endif
                                                                        @endforeach
                                                                    @endif
                                                                    <h3>
