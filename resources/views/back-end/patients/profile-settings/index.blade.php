            ...
            <div class="dc-dashboardbox dc-dashboardtabsholder">
                ...
                <div class="dc-tabscontent tab-content">
                    <div class="dc-personalskillshold tab-pane active fade show" id="dc-skills">
                        @include('back-end.patients.profile-settings.personal-detail.index')
                    </div>    
                </div>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4 col-xl-3 dc-responsive-mt mt-lg-0 mt-xl-0">
        </div>
    </div>
@endsection