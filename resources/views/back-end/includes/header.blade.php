@section('header')
    @php 
        ...
        $user_role = Helper::getRoleTypeByUserID(Auth::user()->id);
    @endphp
    <style >
        .mobile_view_btn{
            display: none;
    ...
    <header id="dc-header" class="dc-header dc-haslayout dc-header-dashboard back_end_logomain">
        <div class="dc-navigationarea">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 less_padding">
                    
                        <strong class="dc-logo"><a href="{{ url('/') }}"><img src="{{ asset(Helper::getGeneralSettings('site_logo')) }}" alt="{{ trans('lang.site_logo') }}"></a> <!-- <a href="{{ url('/') }}"><h5>KNOCKDOC</h5></a> --></strong>
                        <div class="dc-rightarea nav_main backend_header">
                            @if ($user_role !='admin')
                            <nav id="dc-nav" class="dc-nav navbar-expand-lg">
                                ...
                                <div class="collapse navbar-collapse dc-navigation doctor_navbar " id="navbarNav">
                           ...
                           @endif 
                            ...
                            <!-- <div class="dc-search-headerform backend_search">
                            ...
                            <!-- <a href="javascript:void(0);" id="dc-btnmenutoggle" class="dc-searchbtn"><i class="fa fa-bars"></i></a> -->
                        </div>
                        </div>
