    ...
    <div class="row">
        ...
        <div class="dc-dashboardbox">
                ...
                <div class="dc-dashboardboxcontent dc-addspeciality">
                    <form action="{{action('DiagnoseController@update',$diagnoses->id) }}"method="post"> 
                        {{csrf_field()}}
                        @method('post')
                        <div class="form-group">
                                <div class="form-group">
                                       <div class="form-group">
                                    <input type="text" name="name"  class="form-control" placeholder="Service" value="{{ $diagnoses->name }}"/>
                                    @if ($errors->has('name'))  
                                 ...
                                 <div class="form-group">
                                    ...
                                    <select name="speciality_id" id="speciality_id" class="form-control">
                                       ...
                                       @foreach ($specialities as $key => $speciality)
                                        <option value="{{$speciality->id}}"@if($diagnoses->speciality_id == $speciality->id) selected @endif>{{$speciality->title}}</option>
                                        @endforeach
                                    </select>
                                </span>
