    ...
    <div class="dc-impr_opts" id="impr_opts">
        ...
        <section class="dc-haslayout">
            <div class="row">
             ...
             <div class="row">    
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-5 col-xl-5 dc-responsive-mt mt-lg-0 mt-xl-0">
                    <div class="dc-dashboardbox">
                            ...
                            {!! Form::open(['url' => url('admin/store-improvement-opts'), 'class' => 'dc-formtheme dc-formsearch dc-userform', 'id' => 'speclity'])!!}
                                <fieldset>
                                    ...
                                    <div class="form-group dc-btnarea">
                                        {!! Form::button(trans('lang.create_improvement_option'), [ 'type' => 'submit' ,'class' => 'dc-btn']) !!}
                                    </div>
                                </fieldset>
                            {!! Form::close(); !!}
                        </div>
