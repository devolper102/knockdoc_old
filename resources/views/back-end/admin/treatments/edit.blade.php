        ...
        <div class="dc-dashboardbox">
            <div class="dc-dashboardboxtitle dc-titlewithsearch dc-titlewithdel">
                ...
                <div class="dc-dashboardboxtitle">
                    <form action="{{action('TreatmentController@update',$treatments->id) }}"method="post"> 
                        {{csrf_field()}}
                        @method('post')
                        <div class="form-group">
                                <div class="form-group">
                                    <input type="text" name="title"value="{{ $treatments->title }}"id="tag2" class="form-control" placeholder="Enter title" />
                                     @if ($errors->has('title'))  
                                          <br>
                                ...
                                <div class="form-group">
                                    {!! Form::textarea( 'description', e($treatments->description), ['id' => 'description','class' =>'form-control', 'placeholder' => trans('lang.ph.desc')]) !!}
                                </div>  
                                <div class="form-group dc-btnarea">
                                       <input type="submit" name="submit" value="Update Treatment"class="dc-btn">
                                </div>          
                        </div> 
                    </form>
                </div>
...
@stack('backend_scripts')
 ...
 <script src="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.0.0-beta/js/bootstrap.min.js"></script>
    ...
    <script>
      var data =JSON.stringify({!!json_encode($disease)!!});
