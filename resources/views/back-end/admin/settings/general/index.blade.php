            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="dc-dashboardbox dc-dashboardtabsholder">
                    <div class="dc-dashboardtabs">
                        <ul class="dc-tabstitle nav navbar-nav">
                            ...
                            <li class="nav-item">
                             ...
                             <li class="nav-item">
                                <a class="" data-toggle="tab" href="#dc-map-img">{{ trans('Map Image') }}</a>
                            </li>
                        </ul>
                    </div>
                    <div class="dc-tabscontent tab-content">
                        ...
                        <div class="dc-personalskillshold tab-pane fade show" id="dc-map-img">
                            @include('back-end.admin.settings.general.map-img')
                        </div>
                    </div>
                </div>
            </div>
