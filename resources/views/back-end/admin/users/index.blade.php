            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 float-right">
                ...
                <div class="dc-dashboardbox">
                    <div class="dc-dashboardboxtitle dc-titlewithsearch">
                        <h2>{{{'All '. trans('lang.manage_users') }}}</h2>
                        <div class="dc-rightarea">
                            <form action="{{ route('adminAddUser')}}" method="get">
                                <input type="hidden" name="role" value="patient">
                                <input type="submit" name="submit"class="dc-btn" value="Add new Patient">
                    ...
                    <div class="dc-dashboardboxcontent dc-categoriescontentholder table-responsive">
                        @if ($users->count() > 0)
                            <table id="roles_regular"class="table table-hover table-bordered dt-responsive nowrap">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    @foreach ($users as $key => $user_data)
                                        ...
                                        @endphp
                                        @if (Helper::getRoleTypeByUserID($user->id) == 'patient')
                                            <tr class="del-{{{ $user->id }}}">
                                                ...
                                                @elseif (Helper::getRoleTypeByUserID($user->id) == 'patient')
