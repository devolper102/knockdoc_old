        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8 col-xl-6">
            <div class="dc-haslayout dc-dbsectionspacetest">
                <div class="dc-dashboardbox dc-manageteam-wrap">
                    <div class="dc-searchresult-head" style="border-bottom: none; padding-bottom: 5px !important;">
                        <div class="dc-title"><h2>{{ $hospital->first_name }} {{ $hospital->last_name }}</h2></div>
                    </div>
