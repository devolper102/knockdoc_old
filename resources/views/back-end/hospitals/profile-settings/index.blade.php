...
@include('includes.pre-loader')
    <div class="row">
        <div class="col-12 col-md-12 col-lg-12 col-xl-12" id="profile_settings">
            <div class="dc-dashboardbox dc-dashboardtabsholder">
                ...
                <div class="dc-dashboardtabs">
                    <ul class="dc-tabstitle nav navbar-nav">
                        ...
                        <li class="nav-item"><a class="" data-toggle="tab" href="#dc-registration">{{ trans('lang.registration') }}</a></li>
                        <li class="nav-item"><a data-toggle="tab" href="#dc-hospitals" class="">{{ trans('lang.hospital-services') }}</a></li>
                ...
                <div class="dc-tabscontent tab-content">
                    ...
                    <div class="dc-personalskillshold tab-pane fade" id="dc-hospitals">
                        @include('back-end.hospitals.profile-settings.hospital-services.index')
                    </div>
