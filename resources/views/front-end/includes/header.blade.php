...
@endif
@section('header')
    <header id="dc-header" class="dc-header dc-haslayout front_end_logomain">
        <div class="dc-navigationarea" id="header_main">
            <div class="container">
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 less_padding">
                        @if(Auth::user())
                            <strong class="dc-logo"><a href="{{ url('/') }}"><img src="{{ asset(Helper::getGeneralSettings('site_logo')) }}" alt="{{ trans('lang.site_logo') }}"></a>
                        @else
                            <strong class="dc-logo dc-logout"><a href="{{ url('/') }}"><img src="{{ asset(Helper::getGeneralSettings('site_logo')) }}" alt="{{ trans('lang.site_logo') }}"></a>
                        @endif
                        <!-- <a href="{{ url('/') }}"><h5>KNOCKDOC</h5></a> --></strong>
                        <div class="dc-rightarea nav_main front_end">
                            ...
                            @endguest
                            <!-- @auth
                            <div class="dc-loginarea logout_btn mobile_module">
