...
<div id="search_modal" class="modal">
    <div class="modal-content" style="padding-top: 30px; padding-bottom: 30px; width: 90%; height: 1334px; top: 0; position: fixed;">
        ...
        <div class="row mt-2 bg-white padding">
            <div class="col-12">
                <h1 style="font-size: 20px;">Consult a Qualified Dermatologist Online In Pakistan</h1>
    ...
    <div class="col-12-sm col-2">
        ...
        <div class="col-8-sm col-12">
            <h2 class="d-block d-sm-none"><a href="#">Dr. Zafar Ahmed</a> <i class="fa fa-check-circle green-text"></i></h2>
                        <div class="">
    ...
    <div class="col-10">
        <div class="row">
            <div class="col-12 doctor-content">
                <h2 class="d-none d-sm-block"><a href="#">Dr. Zafar Ahmed</a> <i class="fa fa-check-circle green-text"></i></h2>
                <p><b></b></p>
                ...
                <div class="listing-doctor-faqs-online">
                    <div class="col-12-sm col-12">
                        ...
                        <div class="content">
                            Please book your slot <a href="#">here</a> and agent will give you the earliest online time available. You can also call at 0345-0601773 to book
                        </div>
                    </div>
        ...
        <div class="row">
                ...
                <a href="#" class="button-big ga-event-online-consultation-listing ga-event-oc-speciality-listing-button">Book Online Consultation</a>
            </div>
                                </div>
    </div>
    ...
    <div class="col-12-sm col-2">
        <div class="col-4-sm col-12">
                        <div class="doctor-image lazy-image" style="border-radius: 4px" data-src="https://q4q4u7z4.stackpathcdn.com/assets/doctors/5396/dr-umer-mushtaq-dermatologist-lahore_170X170.jpg" data-alt="dr-umer-mushtaq-dermatologist-lahore" data-url="#"></div>
                    </div>

        <div class="col-8-sm col-12">
            <h2 class="d-block d-sm-none"><a href="#">Dr. Umer Mushtaq</a> <i class="fa fa-check-circle green-text"></i></h2>
                        <div class="">
                <!-- <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> -->
    ...
    <div class="col-10">
        <div class="row">
            <div class="col-12 doctor-content">
                <h2 class="d-none d-sm-block"><a href="#">Dr. Umer Mushtaq</a> <i class="fa fa-check-circle green-text"></i></h2>
                <p><b></b></p>
    ...
    <div class="col-12-sm col-2">
        <div class="col-4-sm col-12">
                        <div class="doctor-image lazy-image" style="border-radius: 4px" data-src="https://q4q4u7z4.stackpathcdn.com/assets/doctors/7382/dr-jaffar-ali-dermatologist-quetta-82_170X170.jpeg" data-alt="dr-jaffar-ali-dermatologist-lahore" data-url="#"></div>
                    </div>

        <div class="col-8-sm col-12">
            <h2 class="d-block d-sm-none"><a href="#">Dr. Jaffar Ali</a> <i class="fa fa-check-circle green-text"></i></h2>
                        <div class="">
                <!-- <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> -->
                <span class="rating" data-rating="4.7"></span>
                <span>(4.7 / 5)</span>
    ...
    <div class="col-10">
        <div class="row">
            <div class="col-12 doctor-content">
                <h2 class="d-none d-sm-block"><a href="#">Dr. Jaffar Ali</a> <i class="fa fa-check-circle green-text"></i></h2>
                <p><b></b></p>
    ...
    <div class="col-12-sm col-2">
        <div class="col-4-sm col-12">
                        <div class="doctor-image lazy-image" style="border-radius: 4px" data-src="https://q4q4u7z4.stackpathcdn.com/assets/doctors/7153/dr-nadia-arshad-chaudhary-dermatologist-islamabad-24_170X170.jpg" data-alt="dr-nadia-arshad-chaudhary-dermatologist-lahore" data-url="#"></div>
                    </div>

        <div class="col-8-sm col-12">
            <h2 class="d-block d-sm-none"><a href="#">Dr. Nadia Arshad Chaudhary</a> <i class="fa fa-check-circle green-text"></i></h2>
                        <div class="">
                <!-- <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> -->
                <span class="rating" data-rating="4.7"></span>
                <span>(4.7 / 5)</span>
    ...
    <div class="col-10">
        <div class="row">
            <div class="col-12 doctor-content">
                <h2 class="d-none d-sm-block"><a href="#">Dr. Nadia Arshad Chaudhary</a> <i class="fa fa-check-circle green-text"></i></h2>
                <p><b></b></p>
                ...
                <!-- FAQ'S -->
                    ...
                    <div class="col-12">
                        ...
                        <button type="button" class="collapsible ga-event-online-consultation-listing-faq">Are there any additional charges when you book an appointment through
                            <a href="#">#?</a><i class="fa fa-angle-down u-pull-right"></i></button>
                        <div class="content">
                            <p>No, there are no extra charges to book an appointment through <a href="#">#</a></p>
                                                    </div>
                        ...
                        <div class="content">
                            <p><a href="#">Click Here</a> To book your appointment with a Dermatologist. You can also book your appointment with a Dermatologist by calling at  <a href="tel:042-00591427">042-32591427</a> or <a href="tel:042-00591429">042-32591429</a>. There are no extra charges for booking through Marham.</p>
                                                    </div>
                        ...
                        <div class="content">
                                                                ...
                                                                <ul class="grid-list">
                                                                                        ...
                                                                                        <p class="mt-2">View all the qualified <a href="#/doctors/dermatologist">Dermatologists available in Pakistan</a> at </p>
                                                    </div>
