...
<div id="search_modal" class="modal">
    ...
    <div class="col-12-sm col-2">
        <div class="col-4-sm col-12">
                        <div class="doctor-image lazy-image" style="border-radius: 4px" data-src="https://q4q4u7z4.stackpathcdn.com/assets/doctors/9226/dr-zafar-ahmed-dermatologist-karachi-34_170X170.png" data-alt="dr-zafar-ahmed-dermatologist-lahore" data-url="#/doctors/lahore/dermatologist/dr-zafar-ahmed"></div>
                    </div>

        <div class="col-8-sm col-12">
            <h2 class="d-block d-sm-none"><a href="#/doctors/lahore/dermatologist/dr-zafar-ahmed">Dr. Zafar Ahmed</a> <i class="fa fa-check-circle green-text"></i></h2>
                        <div class="">
    ...
    <div class="col-10">
        <div class="row">
            <div class="col-12 doctor-content">
                <h2 class="d-none d-sm-block"><a href="#/doctors/lahore/dermatologist/dr-zafar-ahmed">Dr. Zafar Ahmed</a> <i class="fa fa-check-circle green-text"></i></h2>
                <p><b></b></p>
                ...
                <div class="list-span mt-2">
                                        ...
                                        <ul class="test-list">
                                                ...
                                                <a href="#/doctors/lahore/dermatologist/dr-zafar-ahmed">
                ...
                <div class="listing-doctor-faqs-online">
                    <div class="col-12-sm col-12">
                        ...
                        <div class="content">
                            Please book your slot <a href="#/online-consultation/request?id=67&d_id=9226">here</a> and agent will give you the earliest online time available. You can also call at 0345-0601773 to book
                        </div>
                    </div>
        ...
        <div class="row">
                ...
                <a href="#/online-consultation/request?id=67&d_id=9226" class="button-big ga-event-online-consultation-listing ga-event-oc-speciality-listing-button">Book Online Consultation</a>
            </div>
                                </div>
    </div>
    ...
    <div class="col-12-sm col-2">
        <div class="col-4-sm col-12">
                        <div class="doctor-image lazy-image" style="border-radius: 4px" data-src="https://q4q4u7z4.stackpathcdn.com/assets/doctors/5396/dr-umer-mushtaq-dermatologist-lahore_170X170.jpg" data-alt="dr-umer-mushtaq-dermatologist-lahore" data-url="#/doctors/lahore/dermatologist/dr-umer-mushtaq"></div>
                    </div>

        <div class="col-8-sm col-12">
            <h2 class="d-block d-sm-none"><a href="#/doctors/lahore/dermatologist/dr-umer-mushtaq">Dr. Umer Mushtaq</a> <i class="fa fa-check-circle green-text"></i></h2>
                        <div class="">
                <!-- <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> -->
    ...
    <div class="col-10">
        <div class="row">
            <div class="col-12 doctor-content">
                <h2 class="d-none d-sm-block"><a href="#/doctors/lahore/dermatologist/dr-umer-mushtaq">Dr. Umer Mushtaq</a> <i class="fa fa-check-circle green-text"></i></h2>
                <p><b></b></p>
                ...
                <div class="list-span mt-2">
                                        ...
                                        <ul class="test-list">
                                                ...
                                                <a href="#/doctors/lahore/dermatologist/dr-umer-mushtaq">
                            <li style="text-decoration: underline;">View All Services</li>
                        </a>
                    </ul>
                ...
                <div class="listing-doctor-faqs-online">
                    <div class="col-12-sm col-12">
                        ...
                        <div class="content">
                            Please book your slot <a href="#/online-consultation/request?id=67&d_id=5396">here</a> and agent will give you the earliest online time available. You can also call at 0345-0601773 to book
                        </div>
                    </div>
        ...
        <div class="row">
                        <div class="col-12-sm col-4">
                <a href="#/online-consultation/request?id=67&d_id=5396" class="button-big ga-event-online-consultation-listing ga-event-oc-speciality-listing-button">Book Online Consultation</a>
            </div>
                                </div>
    </div>
</div>                                  <div class="row bg-white padding doctor-card">
    <div class="col-12-sm col-2">
        <div class="col-4-sm col-12">
                        <div class="doctor-image lazy-image" style="border-radius: 4px" data-src="https://q4q4u7z4.stackpathcdn.com/assets/doctors/7382/dr-jaffar-ali-dermatologist-quetta-82_170X170.jpeg" data-alt="dr-jaffar-ali-dermatologist-lahore" data-url="#/doctors/lahore/dermatologist/dr-jaffar-ali"></div>
                    </div>

        <div class="col-8-sm col-12">
            <h2 class="d-block d-sm-none"><a href="#/doctors/lahore/dermatologist/dr-jaffar-ali">Dr. Jaffar Ali</a> <i class="fa fa-check-circle green-text"></i></h2>
                        <div class="">
                <!-- <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> -->
                <span class="rating" data-rating="4.7"></span>
                <span>(4.7 / 5)</span>
    ...
    <div class="col-10">
        <div class="row">
            <div class="col-12 doctor-content">
                <h2 class="d-none d-sm-block"><a href="#/doctors/lahore/dermatologist/dr-jaffar-ali">Dr. Jaffar Ali</a> <i class="fa fa-check-circle green-text"></i></h2>
                <p><b></b></p>
                ...
                <div class="list-span mt-2">
                                        ...
                                        <ul class="test-list">
                                                ...
                                                <a href="#/doctors/lahore/dermatologist/dr-jaffar-ali">
                            <li style="text-decoration: underline;">View All Services</li>
                        </a>
                    </ul>
                ...
                <div class="listing-doctor-faqs-online">
                    <div class="col-12-sm col-12">
                        ...
                        <div class="content">
                            Please book your slot <a href="#/online-consultation/request?id=67&d_id=7382">here</a> and agent will give you the earliest online time available. You can also call at 0345-0601773 to book
                        </div>
                    </div>
        ...
        <div class="row">
                        <div class="col-12-sm col-4">
                <a href="#/online-consultation/request?id=67&d_id=7382" class="button-big ga-event-online-consultation-listing ga-event-oc-speciality-listing-button">Book Online Consultation</a>
            </div>
                                </div>
    </div>
</div>                                  <div class="row bg-white padding doctor-card">
    <div class="col-12-sm col-2">
        <div class="col-4-sm col-12">
                        <div class="doctor-image lazy-image" style="border-radius: 4px" data-src="https://q4q4u7z4.stackpathcdn.com/assets/doctors/7153/dr-nadia-arshad-chaudhary-dermatologist-islamabad-24_170X170.jpg" data-alt="dr-nadia-arshad-chaudhary-dermatologist-lahore" data-url="#/doctors/lahore/dermatologist/dr-nadia-arshad-chaudhary"></div>
                    </div>

        <div class="col-8-sm col-12">
            <h2 class="d-block d-sm-none"><a href="#/doctors/lahore/dermatologist/dr-nadia-arshad-chaudhary">Dr. Nadia Arshad Chaudhary</a> <i class="fa fa-check-circle green-text"></i></h2>
                        <div class="">
                <!-- <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> -->
                <span class="rating" data-rating="4.7"></span>
                <span>(4.7 / 5)</span>
    ...
    <div class="col-10">
        <div class="row">
            <div class="col-12 doctor-content">
                <h2 class="d-none d-sm-block"><a href="#/doctors/lahore/dermatologist/dr-nadia-arshad-chaudhary">Dr. Nadia Arshad Chaudhary</a> <i class="fa fa-check-circle green-text"></i></h2>
                <p><b></b></p>
                ...
                <div class="list-span mt-2">
                                        ...
                                        <ul class="test-list">
                                                ...
                                                <li style="font-family: Tahoma;">وٹیلیگو</li>
                                                <li style="font-family: Tahoma;">جلے کا علاج</li>
                                                <a href="#/doctors/lahore/dermatologist/dr-nadia-arshad-chaudhary">
                            <li style="text-decoration: underline;">View All Services</li>
                        </a>
                    </ul>
                ...
                <div class="listing-doctor-faqs-online">
                    <div class="col-12-sm col-12">
                        ...
                        <div class="content">
                            Please book your slot <a href="#/online-consultation/request?id=67&d_id=7153">here</a> and agent will give you the earliest online time available. You can also call at 0345-0601773 to book
                        </div>
                    </div>
        ...
        <div class="row">
                        <div class="col-12-sm col-4">
                <a href="#/online-consultation/request?id=67&d_id=7153" class="button-big ga-event-online-consultation-listing ga-event-oc-speciality-listing-button">Book Online Consultation</a>
            </div>
                                </div>
    </div>
</div>                          </div>
                ...
                <!-- FAQ'S -->
                    ...
                    <div class="col-12">
                        ...
                        <button type="button" class="collapsible ga-event-online-consultation-listing-faq">Are there any additional charges when you book an appointment through
                            <a href="#">marham.pk?</a><i class="fa fa-angle-down u-pull-right"></i></button>
                        <div class="content">
                            <p>No, there are no extra charges to book an appointment through <a href="#">marham.pk</a></p>
                                                    </div>
                        ...
                        <div class="content">
                                                                ...
                                                                <ul class="grid-list">
                                                                                                                <li><a href="#/doctors/lahore/dermatologist/dr-pervaiz-lateef">Dr. Pervaiz Lateef</a></li>
                                                                                                                    <li><a href="#/doctors/lahore/dermatologist/dr-atif-kazmi">Dr. Atif Kazmi</a></li>
                                                                                                                    <li><a href="#/doctors/lahore/dermatologist/dr-jaffar-ali">Dr. Jaffar Ali</a></li>
                                                                                                                    <li><a href="#/doctors/lahore/dermatologist/dr-shagufta-shafi">Dr. Shagufta Shafi</a></li>
                                                                                                                    <li><a href="#/doctors/lahore/dermatologist/dr-samina-noor">Dr. Samina Noor</a></li>
                                                                                                            </ul>
                                                                                        <p class="mt-2">View all the qualified <a href="#/doctors/dermatologist">Dermatologists available in Pakistan</a> at Marham.pk</p>
                                                    </div>
                        ...
                        <div class="content">
                                                                ...
                                                                <ul class="grid-list">
                                                                                                                <li><a href="#/doctors/lahore/dermatologist/dr-zafar-ahmed">Dr. Zafar Ahmed</a></li>
                                                                                                                    <li><a href="#/doctors/lahore/dermatologist/dr-umer-mushtaq">Dr. Umer Mushtaq</a></li>
                                                                                                                    <li><a href="#/doctors/lahore/dermatologist/dr-jaffar-ali">Dr. Jaffar Ali</a></li>
                                                                                                                    <li><a href="#/doctors/lahore/dermatologist/dr-tariq-niaz-butt">Dr. Tariq Niaz Butt</a></li>
                                                                                                                    <li><a href="#/doctors/lahore/dermatologist/dr-anita-kazi">Dr. Anita Kazi</a></li>
                                                                                                            </ul>
                                                                                        <p class="mt-2">View all the qualified <a href="#/doctors/dermatologist">Dermatologists available in Pakistan</a> at Marham.pk</p>
                                                    </div>
                                                                    </div>
           ...
           <div class="col-12">
               <h2 class="mb-2">Dermatologist in different cities of Pakistan</h2>
                               <div class="content1">
                                           <ul class="grid-list">
                                                                                                               <li><a href="#/online-consultation/dermatologist/abbottabad">Dermatologists in Abbottabad</a></li>
                                                                                                                                               <li><a href="#/online-consultation/dermatologist/faisalabad">Dermatologists in Faisalabad</a></li>
                                                                                                                                               <li><a href="#/online-consultation/dermatologist/gujranwala">Dermatologists in Gujranwala</a></li>
                                                                                                                                               <li><a href="#/online-consultation/dermatologist/haripur">Dermatologists in Haripur</a></li>
                                                                                                                                               <li><a href="#/online-consultation/dermatologist/hyderabad">Dermatologists in Hyderabad</a></li>
                                                                                                                                               <li><a href="#/online-consultation/dermatologist/islamabad">Dermatologists in Islamabad</a></li>
                                                                                                                                               <li><a href="#/online-consultation/dermatologist/karachi">Dermatologists in Karachi</a></li>
                                                                                                                                               <li><a href="#/online-consultation/dermatologist/lahore">Dermatologists in Lahore</a></li>
                                                                                                                                               <li><a href="#/online-consultation/dermatologist/london">Dermatologists in London</a></li>
                                                                                                                                               <li><a href="#/online-consultation/dermatologist/mianwali">Dermatologists in Mianwali</a></li>
                                                                                                                                               <li><a href="#/online-consultation/dermatologist/multan">Dermatologists in Multan</a></li>
                                                                                                                                               <li><a href="#/online-consultation/dermatologist/okara">Dermatologists in Okara</a></li>
                                                                                                                                               <li><a href="#/online-consultation/dermatologist/peshawar">Dermatologists in Peshawar</a></li>
                                                                                                                                               <li><a href="#/online-consultation/dermatologist/quetta">Dermatologists in Quetta</a></li>
                                                                                                                                               <li><a href="#/online-consultation/dermatologist/rahim-yar-khan">Dermatologists in Rahim Yar Khan</a></li>
                                                                                                                                               <li><a href="#/online-consultation/dermatologist/rawalpindi">Dermatologists in Rawalpindi</a></li>
                                                                                                                                               <li><a href="#/online-consultation/dermatologist/sadiqabad">Dermatologists in Sadiqabad</a></li>
                                                                                                                                               <li><a href="#/online-consultation/dermatologist/sialkot">Dermatologists in Sialkot</a></li>
                                                                                                       </ul>
                                       </div>
                                       </div>
       </div>
