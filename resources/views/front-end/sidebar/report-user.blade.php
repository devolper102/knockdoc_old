<div class="dc-widget dc-reportform-holder">
    ...
    <div class="dc-widgetcontent">
        ...
        <div class="dc-appemail-form">
            {!! Form::email('email', null, ['class' => 'form-control', 'v-model' => 'report.email', 'placeholder' => trans('lang.ph_email')]) !!}
        </div>
        <div class="form-group">
            {!! Form::text('phone_number', null, ['class' => 'form-control', 'v-model' => 'report.phone_number', 'placeholder' => '03xxxxxxxxx']) !!}
        </div>
        <div class="form-group">
