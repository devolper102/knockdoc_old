                ...
                <div id="dc-accordion" class="dc-accordion" role="tablist" aria-multiselectable="true">
                    <div class="dc-panel">
                        <div class="dc-paneltitle">
                            <figure class="dc-titleicon"><img src="{{ asset(Helper::getImage('uploads/specialities', $speciality->image, 'extra-small-', 'speciality-default.png')) }}" alt="{{ trans('lang.img_desc') }}"></figure>
